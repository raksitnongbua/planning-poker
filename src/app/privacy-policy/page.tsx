  ...
  return (
    <div className="px-4 pb-5 sm:px-10">
      <div className="mx-auto max-w-screen-lg [&>h1]:my-8 [&>h2]:my-4 [&>p]:my-4 [&h3]:my-3 [&h4]:my-3 [&h4]:text-xl">
        ...
        <ul className="ml-6 list-disc">
          ...
          <li>
            <p>
              ...
              &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Corgi
              Planning Poker.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Corgi Planning Poker, accessible from{' '}
              <a
                href="https://www.corgiplanningpoker.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.corgiplanningpoker.com
              </a>
            </p>
          </li>
          <li>
        ...
        <h4 className="text-3xl">{`Children's Privacy`}</h4>
        <p>
        ...
        <h4 className="text-3xl">Links to Other Websites</h4>
        <p>
        ...
        <ul className="ml-6 list-disc">
          <li>By email: tan.raksit@gmail.com</li>
        </ul>
      </div>
    </div>
  )
